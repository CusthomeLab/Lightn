...
export class PictureStore {
    ...
    addPicture(path, relative, name, width, height, size, base64, newWidth, newHeight, newSize, newBase64) {
        this.pictures.push(new Picture(path, relative, name, width, height, size, base64, newWidth, newHeight, newSize, newBase64))
    }
